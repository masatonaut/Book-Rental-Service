        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('librarian.genres.create')" :active="request()->routeIs('librarian.dashboard')">
                        Add New Genre
                    </x-nav-link>
                    <x-nav-link :href="route('librarian.genres.index')" :active="request()->routeIs('librarian.dashboard')">
                        List Genres
                    </x-nav-link>
